...
async def auth_headers(db_container):
    ...
    await service.register(
        email="admin@example.com", username="admin", nickname="test_user", password="admin123"
    )
    result = await service.register(
        email="test@example.com", username="testuser", nickname="test_user", password="testpass123"
    )

...
// Router stubs
// /admin/users/posts    — 暂未实现
// /admin/users/comments — 暂未实现
// /admin/users/assets   — 暂未实现
...
const cards: CardItem[] = [
  ...
  },
  {
    ...
    icon: ImageOutline,
    stats: [
      { label: '总文件', value: '2345 个' },
      { label: '总存储', value: '1.2 GB' },
      { label: '本月新增', value: '89 MB' }
    ],

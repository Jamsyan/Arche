...
import { NButton, NInput, NSelect, NSpace, NTag, NEmpty, NPopconfirm, useMessage } from 'naive-ui'
import {
  getBlogPostsApi,
  approvePostApi,
  rejectPostApi,
...
const statusLabel = (s: string | undefined) =>
  statusMap[s ?? ''] || { label: s ?? '未知', type: 'default' as const }
  ...
  <div class="moderation-page">
    ...
    <div class="toolbar">
      ...
      <div class="toolbar-right">
        <NButton size="small" secondary @click="fetchPosts()">刷新</NButton>
      </div>
    </div>
        ...
        <div v-else class="post-cards">
          ...
          >
            <div class="card-header">
              ...
              <NTag size="tiny" :type="statusLabel(post.status).type">
      ...
      <div class="detail-panel">
        <template v-if="selectedPost">
          <div class="detail-header">
            ...
            <NSpace size="small">
              <NButton size="tiny" type="success" @click="doApprove(selectedPost.id)">通过</NButton>
              <NButton size="tiny" type="warning" @click="doReject(selectedPost.id)">驳回</NButton>
              <NPopconfirm
                title="确认删除"
          ...
          <div class="detail-meta">
            ...
            <span
              >状态：<NTag size="tiny" :type="statusLabel(selectedPost.status).type">{{

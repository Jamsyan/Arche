  ...
  <div class="create-page">
    ...
    <div class="editor-toolbar">
      ...
      <div class="toolbar-actions">
        ...
        <ArButton type="primary" size="sm" :loading="saving" :disabled="saving" @click="handleSave">发布</ArButton>
      </div>
      ...
      <div v-if="showAccessPopover" class="toolbar-popover access-popover" @click.stop>
        ...
        <div class="popover-access-options">
          <button
            ...
            @click="editorAccess = level; showAccessPopover = false"
          >
...
function cardsToPayload(): CreatePostPayload {
  ...
  // 添加副标题
  const validSubtitles = subtitles.value
    .map((s) => s.value.trim())
    .filter(Boolean)

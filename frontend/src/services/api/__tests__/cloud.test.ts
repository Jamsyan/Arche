...
vi.mock('../../request', () => ({ get: vi.fn(), post: vi.fn(), del: vi.fn() }))
beforeEach(() => {
  vi.clearAllMocks()
})
...
describe('cloud API', () => {
  it('getCloudStatsApi', async () => {
    const { getCloudStatsApi } = await import('../cloud')
  ...
  it('getCloudJobsApi 传 status 参数', async () => {
    const { getCloudJobsApi } = await import('../cloud')
    const { get } = await import('../../request')
  ...
  it('getCloudJobDetailApi 拼接 jobId', async () => {
    const { getCloudJobDetailApi } = await import('../cloud')
    const { get } = await import('../../request')
  ...
  it('createCloudJobApi', async () => {
    const { createCloudJobApi } = await import('../cloud')
  ...
  it('deleteCloudJobApi', async () => {
    const { deleteCloudJobApi } = await import('../cloud')
  ...
  it('startCloudJobApi 和 stopCloudJobApi', async () => {
    const { startCloudJobApi, stopCloudJobApi } = await import('../cloud')
    const { post } = await import('../../request')
  ...
  it('getCloudJobLogsApi 传 lines 参数', async () => {
    const { getCloudJobLogsApi } = await import('../cloud')
    const { get } = await import('../../request')
  ...
  it('getCloudJobProgressApi', async () => {
    const { getCloudJobProgressApi } = await import('../cloud')
    const { get } = await import('../../request')
  ...
  it('listDatasetsApi', async () => {
    const { listDatasetsApi } = await import('../cloud')
    const { get } = await import('../../request')
    vi.mocked(get).mockResolvedValue({ items: [], total: 0 })
  ...
  it('createDatasetApi', async () => {
    const { createDatasetApi } = await import('../cloud')
    const { post } = await import('../../request')
  ...
  it('listReposApi', async () => {
    const { listReposApi } = await import('../cloud')
    const { get } = await import('../../request')
    vi.mocked(get).mockResolvedValue({ items: [], total: 0 })
    await listReposApi()
  ...
  it('listArtifactsApi', async () => {
    const { listArtifactsApi } = await import('../cloud')
    const { get } = await import('../../request')
    vi.mocked(get).mockResolvedValue({ items: [], total: 0 })
  ...
  it('downloadArtifactApi', async () => {
    const { downloadArtifactApi } = await import('../cloud')
    const { get } = await import('../../request')

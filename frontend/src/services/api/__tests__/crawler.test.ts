...
describe('crawler API', () => {
  it('getCrawlerStatusApi', async () => {
    const { getCrawlerStatusApi } = await import('../crawler')
  ...
  it('startCrawlerApi', async () => {
    const { startCrawlerApi } = await import('../crawler')
  ...
  it('getCrawlerRecordsApi', async () => {
    const { getCrawlerRecordsApi } = await import('../crawler')
    const { get } = await import('../../request')
  ...
  it('getCrawlerRecordApi 拼接 ID', async () => {
    const { getCrawlerRecordApi } = await import('../crawler')
    const { get } = await import('../../request')
  ...
  it('addCrawlerSeedApi 封装 url', async () => {
    const { addCrawlerSeedApi } = await import('../crawler')
    const { post } = await import('../../request')
    vi.mocked(post).mockResolvedValue(undefined)

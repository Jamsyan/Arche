...
describe('oss API', () => {
  it('getMyOssFilesApi 解包 data.files', async () => {
    const { getMyOssFilesApi } = await import('@/services/api/oss')
  ...
  it('deleteOssFileApi 拼接 fileId', async () => {
    const { deleteOssFileApi } = await import('@/services/api/oss')
  ...
  it('getOssAdminStatsApi', async () => {
    const { getOssAdminStatsApi } = await import('@/services/api/oss')
    const { get } = await import('@/services/request')
  ...
  it('updateOssUserQuotaApi 拼接 userId', async () => {
    const { updateOssUserQuotaApi } = await import('@/services/api/oss')
  ...
  it('getOssRateLimitApi', async () => {
    const { getOssRateLimitApi } = await import('@/services/api/oss')
    const { get } = await import('@/services/request')

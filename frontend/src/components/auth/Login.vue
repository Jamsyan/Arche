    ...
    <div class="auth-form-side">
      <div class="auth-form-inner">
        ...
        <a-form :model="form" layout="vertical" @submit="handleLogin">
          <a-form-item field="identity" label="邮箱/用户名">
            <a-input v-model="form.identity" placeholder="输入邮箱或用户名" allow-clear />
          </a-form-item>
        ...
        <div class="auth-footer">
          <a-typography-text type="secondary">
            还没有账户？
            <a class="auth-link" @click="$router.push('/register')">创建账户</a>
          </a-typography-text>
        </div>
      </div>
    </div>
